...
describe("service commands", () => {
  ...
  test("manages a Windows login task", () => {
    ...
    const definitionPath = join(appDataDir, "herdr-gui", "herdr-gui-task.ps1");
    const configPath = join(appDataDir, "herdr-gui", "herdr-gui.env");
    const runtime = {
      platform: "win32",
      homeDir,
      appDataDir,
    ...
    expect(commands[0]).toEqual({
      argv: ["schtasks.exe", "/Query", "/TN", "dev.herdr.herdr-gui"],
      quiet: true,
    });
    expect(
